<?php
// controlador/cmn_anexo_fase2_save.php
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Consultar la BD por el DNI para mayor seguridad
    ...
    if (isset($_FILES['anexo_pdf']) && $_FILES['anexo_pdf']['error'] === UPLOAD_ERR_OK) {
        ...
        $new_filename = "ANEXO02_" . $dni . "_" . $safe_sub_unidad . "_" . $fecha_hora . ".pdf";
        
        $upload_dir = __DIR__ . '/../uploads/cmn_fase2/';
        ...
        if (move_uploaded_file($file_tmp, $upload_dir . $new_filename)) {
            ...
            $ruta_db = "uploads/cmn_fase2/" . $new_filename;
            
            $sql = "INSERT INTO cmn_anexos_fase2 (dni_responsable, nombres_completos, region_policial, divopus, sub_unidad, monto_total, archivo_pdf, ip_cliente) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                ...
                $_SESSION['msg_texto'] = "¡Anexo N° 02 de ".$sub_unidad." enviado y recepcionado correctamente!";
            } else {
                $_SESSION['msg_status'] = "error";
                $_SESSION['msg_texto'] = "Error guardando en la Base de Datos.";
            }
            $stmt->close();
        } else {
            $_SESSION['msg_status'] = "error";
        ...
        $_SESSION['msg_status'] = "error";
        $_SESSION['msg_texto'] = "No se adjuntó ningún archivo válido.";
    }
