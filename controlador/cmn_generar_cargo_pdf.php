...
// Protocolo y Host Dinámico (Se adapta a cualquier hosting)
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? "https://" : "http://";
$host = $_SERVER['HTTP_HOST'];
$scriptPath = $_SERVER['SCRIPT_NAME']; // Ejemplo: /controlador/cmn_generar_cargo_pdf.php
$baseDir = dirname(dirname($scriptPath)); // Sube 2 niveles para llegar a la raíz
$baseDir = ($baseDir === '/' || $baseDir === '\\' || $baseDir === '.') ? '' : $baseDir;

$urlValidacion = $protocol . $host . $baseDir . "/cmn_verificar.php?codigo=" . $codigo_cargo;

// API de QuickChart con nivel Q (Mejor balance para escaneo rápido)
$qrApiUrl = "https://quickchart.io/qr?text=" . urlencode($urlValidacion) . "&size=150&margin=0&ecLevel=Q";
        ...
        <tr>
            ...
            <td style="width: 15%; text-align: right;">
                <div style="text-align: center;">
                    <img src="' . $base64Qr . '" style="width: 80px; height: 80px; border: 1px solid #eee; padding: 2px;">
