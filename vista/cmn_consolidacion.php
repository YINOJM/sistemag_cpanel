...
$sql_stats = "SELECT 
    ...
    (SELECT COUNT(*) FROM cmn_anexos_fase3 a INNER JOIN cmn_responsables r ON a.dni_responsable COLLATE utf8mb4_unicode_ci = r.dni COLLATE utf8mb4_unicode_ci WHERE r.anio_proceso = $anio) as recibidos,
    (SELECT SUM(a.monto_total) FROM cmn_anexos_fase3 a INNER JOIN cmn_responsables r ON a.dni_responsable COLLATE utf8mb4_unicode_ci = r.dni COLLATE utf8mb4_unicode_ci WHERE r.anio_proceso = $anio) as monto_total";
...
$sql_tabla = "SELECT 
              ...
              LEFT JOIN cmn_anexos_fase3 a ON r.dni COLLATE utf8mb4_unicode_ci = a.dni_responsable COLLATE utf8mb4_unicode_ci 
