...
// 3. Consulta de registros (Joineado con Responsables para Grado, CIP y Celular)
$sql_tabla = "SELECT 
...
<head>
    ...
    <style>
        ...
        .filter-card {
            ...
            border-radius: var(--card-radius);
            padding: 1.2rem;
            border-left: 5px solid var(--mef-orange);
        }
        ...
        .btn-modern-primary { background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; border: none; padding: 8px 16px; border-radius: 10px; font-weight: 600; text-decoration: none; }
...
<body>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-md-7">
                    <h2 class="fw-semibold mb-0" style="color: #1e293b; font-size: 1.7rem; letter-spacing: -0.5px;">
                        <i class="fa-solid fa-tags me-2" style="color: #eab308; font-size: 1.5rem;"></i> (ii) Fase de Clasificación y Priorización
                    ...
                    <p class="text-muted small mb-0">Recepción de Anexos N° 02 conforme al Cuadro Multianual de Necesidades.</p>
                </div>
                <div class="col-md-5 text-md-end d-flex gap-2 justify-content-md-end mt-2 mt-md-0">
                    ...
                    <a href="cmn_clasificacion_subir.php" target="_blank" class="btn btn-header-add btn-sm px-3">
                        <i class="fa-solid fa-plus me-2"></i> Nuevo Registro
                    </a>
                    <div class="d-flex gap-2 border-start ps-3 ms-2 align-items-center">
                        <button class="btn btn-export-pro bg-excel" title="Exportar a Excel" onclick="exportarExcel(2)">
                            <i class="fa-solid fa-file-excel"></i> EXCEL
                        </button>
                        <button class="btn btn-export-pro bg-pdf" title="Exportar a PDF" onclick="exportarPDF(2)">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    <div class="glass-panel text-center py-2 border-0 shadow-sm" style="background: white; border-radius: 10px;">
                        <p class="text-muted small fw-bold mb-0 text-uppercase" style="font-size: 0.65rem;">Subunidades con Anexo N° 02</p>
                ...
                <form method="GET" class="row g-2 align-items-end" id="formFiltro">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <button class="btn btn-warning fw-bold" type="submit">FILTRAR</button>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <a href="cmn_clasificacion.php" class="btn btn-light btn-sm w-100 border"><i class="fa-solid fa-sync"></i></a>
                    </div>
                </form>
            </div>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        <button class="btn-action btn-obs"
                                            ...
                                            onclick="observarWhatsApp('<?= $row['celular'] ?>', '<?= addslashes($row['nombres_completos']) ?>', '<?= $row['anexo_id'] ?>', '<?= addslashes($row['grado']) ?>', 2)">
    ...
    <script>
        function copyPublicLink() {
            const link = "<?= FULL_BASE_URL . 'vista/cmn_clasificacion_subir.php' ?>";

            navigator.clipboard.writeText(link).then(() => {
                Swal.fire({
                    icon: 'success',
                    title: '¡Enlace Copiado!',
                    text: 'El enlace para Fase de Clasificación y Priorización ya está en tu portapapeles.',
                    timer: 1500,
        ...
        function renderPaginControls(totalPages) {
            ...
            const btnStyle = (active) => `
                ...
                border-color:${active ? '#f59e0b' : '#dee2e6'};`;
            ...
            // Simple pagination: Prev, Current, Next (Expanding logic later if needed)
        ...
        function toggleFormStatus(newState) {
            const statusText = newState === 1 ? 'CERRAR la recepción de Anexos N° 02' : 'ABRIR la recepción de Anexos N° 02';
            Swal.fire({
        ...
        function validarAnexo() {
            ...
            Swal.fire({
                ...
                text: "Se marcará el documento del Anexo N° 02 como conforme.",
                icon: 'question',
                showCancelButton: true,
        ...
        function observarWhatsApp(celular, nombre, id, grado, fase) {
            ...
            const faseTxt = fase === 2 ? 'Anexo N° 02 - Fase de Clasificación' : 'CMN Final - Fase de Consolidación';
        ...
        function copyPublicLink() {
            const url = "<?= FULL_BASE_URL ?>vista/cmn_clasificacion_subir.php";
            navigator.clipboard.writeText(url).then(() => {
                Swal.fire({ icon: 'success', title: '¡Enlace Copiado!', text: 'El enlace público del Anexo 02 ya está en su portapapeles.', timer: 1500, showConfirmButton: false });
            });
        }
